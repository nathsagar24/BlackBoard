...
import com.dell.blackboard.view.HomeView;
...
public class LiveMainModel {
    ...
    public void CHECK_CONTROL(){
        ...
        Log.v("TAG","CHECK_CONTROL called");
        dRef.child("maintainance").setValue(Integer.valueOf(1));
        dRef.child("version").setValue("v005");
        dRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.v("TAG",""+control_state+" "+version);
